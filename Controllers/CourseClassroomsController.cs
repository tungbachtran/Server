...
namespace api.Controllers
{
    ...
    public class CourseClassroomsController : ControllerBase
    {
        ...
        public CourseClassroomsController(StudentContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CourseClassroom>> PostCourseClassroom(CreateCourseClassroomDto request)
        {
            ...
            // Tìm course với CourseId từ request
            ...
            if (CourseClassroomExists(request.CourseClassId))
            {
                return Conflict("Course classroom with the same ID already exists.");
            }

            // Tạo đối tượng CourseClassroom
            ...
            // Thêm courseClassroom vào context
